...
const slack = {
  web: new WebClient(process.env.OLD_MODEL_SLACK_TEST_TOKEN),
...
module.exports = (robot) => {
  ...
  app.get('/slack/deep/:type', (req, res) => {
    res.redirect(`slack://${req.params.type}?${querystring.stringify(req.query)}`);
  });
};
