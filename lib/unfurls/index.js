    ...
    if (action === 'unfurl-dismiss') {
      ...
      return res.send({
        ...
        attachments: [{
          ...
          color: '#24292f',
          text: `[Needs copy improvement] You can enable automatic previews for links to ${owner}/${repo} that *you* post either to this channel or to all channels in the \`${team.domain}\` workspace.`,
