...
module.exports = (robot) => {
  ...
  router.post('/actions:message_action:attach-to-issue', create.attachToIssueFromMessage);
  router.post('/actions:dialog_submission:add-comment-dialog', create.createCommentFromDialog);

  // router.post('/actions:message_action:create-issue', create.openIssueFromMessage);
