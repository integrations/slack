...
module.exports = (robot) => {
  ...
  router.post('/actions:dialog_submission:create-issue-dialog', create.issue.submit);
  router.post('/actions:dialog_submission:create-deployment-dialog', create.deployment.submit);
