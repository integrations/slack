...
module.exports = class AutoUnfurlPrompt extends Message {
  ...
  getAttachment() {
    return {
      ...
      text: `You can enable automatic previews for links to ${this.owner}/${this.repo} that *you* post either to this channel or to all channels in the \`${this.team.domain}\` workspace.`,
