...
class Status extends Message {
  constructor(checkOrStatus) {
    super({});
    /*  error, failure, pending, success, queued, in_progress,
        completed, neutral, cancelled, timed_out, or action_required
    */
    ...
    this.description = checkOrStatus.description ||
      checkOrStatus.output.title ||
      checkOrStatus.name;
