...
const commands = [
  ...
  {
    usage: 'subscribe owner/repository label:my-label [label:"other label" label:priority:high]',
    desc: 'Create one or more label filters. Issues, comments, PRs without that label are ignored',
  },
  {
    usage: 'unsubscribe owner/repository label:my-label [label:"other label" label:teams/designers]',
    desc: 'Remove one or more label filters. The given labels are no longer required',
  },
  {
