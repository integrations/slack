...
const commands = [
  ...
  {
    usage: 'subscribe owner/respository reviews,comments',
  ...
  {
    usage: 'unsubscribe owner/respository commits',
    desc: 'Unsubecribe from one or more individual subscription features',
  },
  {
