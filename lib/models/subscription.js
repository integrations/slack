...
module.exports = (sequelize, DataTypes) => {
  ...
  const Subscription = sequelize.define('Subscription', {
    ...
    settings: {
      ...
      set(values) {
        console.error('Called in settings setter :/ ', values);
        // if (Array.isArray(values) || typeof values === 'string') {
        // this.enableFeatures(values);
        // } else {
        // Object.assign(this.settings, values);
        // }
        console.error('Using unwanted setter: :(');
        const features = parseFeatures(values.features, true);
        const mergedSettings = mergeLabelsAndFeatures(values.labels, features);
  ...
  Object.assign(Subscription.prototype, {
    ...
    enable(settings) {
      ...
      if (settings) {
        console.log('enable feature with: ', settings);
        ...
        console.log('enable feature merged: ', mergedSettings);
        this.enableFeatures(mergedSettings);
      }
    },
    ...
    disableFeatures(features) {
      ...
      Object.entries(features).forEach(([name, value]) => {
        ...
        if (Array.isArray(DefaultSettings[name])) {
          ...
          console.log(`new settings for ${name} is `, newSettings);
