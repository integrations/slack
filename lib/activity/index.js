...
const { repositoryDispatch } = require('./repository-dispatch');
...
module.exports = (robot) => {
  ...
  robot.on(['status', 'check_run'], route(onStatusOrCheckRun));
  ...
  robot.on('repository_dispatch.notify_slack', route(repositoryDispatch));
};
