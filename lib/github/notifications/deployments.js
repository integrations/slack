// check if sha and ref are the same, if that's the case try and get actual ref using GitHub API
// need to store deployment id to update it later
// need to implement logic to attach this to pull requests
