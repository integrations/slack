...
describe('Integration: Creating and listing deployments from Slack', () => {
  ...
  test('works when specifying a repository with no tags', async () => {
    ...
    nock('https://api.github.com').get('/repos/kubernetes/kubernetes/branches').reply(200, fixtures.branches);
    nock('https://api.github.com').get('/repos/kubernetes/kubernetes/git/refs/tags').reply(404, {});
  ...
  test('informs to accept new permissions', async () => {
    ...
    nock('https://api.github.com').post('/repos/kubernetes/kubernetes/deployments').reply(404, {});
