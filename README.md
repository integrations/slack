...
### Installation
[Install the GitHub integration for Slack](https://github.slack.com/apps/A01BP7R4KNY-github). After you've signed in to your Slack workspace, you will be prompted to give the app access:
